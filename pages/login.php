...
<main>
  ...
  <form action="../actions/action_login.php" class="form-box" method="post">
    ...
    <input type="text" name="name" placeholder="Name" hidden>
    ...
    <div class="requirements-todo-list" hidden>
      ...
      <div class="requirement-todo-item ">
        <div class="requirement-todo-icon pull-left">
          <i id="password_lowercase_icon" class="fa fa-info-circle" aria-hidden="true"></i>
      ...
      <div class="requirement-todo-item ">
        <div class="requirement-todo-icon pull-left">
          <i id="password_uppercase_icon" class="fa fa-info-circle" aria-hidden="true"></i>
          <div class="icon-checkmark-small"></div>
        </div>
        <div class="requirement-todo-text pull-left">
      ...
      <div class="requirement-todo-item">
        <div class="requirement-todo-icon pull-left">
          <i id="password_number_icon" class="fa fa-info-circle" aria-hidden="true"></i>
          <div class="icon-checkmark-small"></div>
        </div>
        <div class="requirement-todo-text pull-left">
      ...
      <div class="requirement-todo-item ">
        <div class="requirement-todo-icon pull-left">
          <i id="password_special_icon" class="fa fa-info-circle" aria-hidden="true"></i>
          <div class="icon-checkmark-small"></div>
        </div>
        <div class="requirement-todo-text pull-left">
      ...
      <div class="requirement-todo-item ">
        <div class="requirement-todo-icon pull-left">
          <i id="password_min_length_icon" class="fa fa-info-circle" aria-hidden="true"></i>
          <div class="icon-checkmark-small"></div>
        </div>
        <div class="requirement-todo-text pull-left">
