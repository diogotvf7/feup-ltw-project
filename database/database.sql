...
(
    ...
    Date datetime NOT NULL,
    FOREIGN KEY (TicketID) REFERENCES Ticket(TicketID),
    FOREIGN KEY (AuthorID) REFERENCES Client(ClientID)
);
...
INSERT INTO Ticket_Comment (CommentID, TicketID, AuthorID, Comment, Date)
VALUES (1, 1, 3, "Thanks for submitting this ticket! We'll get back to you as soon as possible.", '2023-06-22 15:12:30');
INSERT INTO Ticket_Comment (CommentID, TicketID, AuthorID, Comment, Date)
VALUES (2, 1, 3, "Just checking in to let you know we're still working on this issue.", '2023-08-15 10:23:45');
INSERT INTO Ticket_Comment (CommentID, TicketID, AuthorID, Comment, Date)
VALUES (3, 1, 3, "We're making progress on resolving this issue. Hang tight!", '2023-11-01 08:40:21');
INSERT INTO Ticket_Comment (CommentID, TicketID, AuthorID, Comment, Date)
VALUES (4, 1, 3, "We've identified the problem and are working on a fix. Thanks for your patience.", '2023-05-09 18:56:02');
INSERT INTO Ticket_Comment (CommentID, TicketID, AuthorID, Comment, Date)
VALUES (5, 1, 5, "I'm assigning this ticket to myself and will take ownership of resolving it.", '2023-09-13 11:34:56');
INSERT INTO Ticket_Comment (CommentID, TicketID, AuthorID, Comment, Date)
VALUES (6, 2, 4, "Thanks for reaching out about this issue. We'll investigate and get back to you soon.", '2023-07-04 22:01:10');
INSERT INTO Ticket_Comment (CommentID, TicketID, AuthorID, Comment, Date)
VALUES (7, 3, 6, "I'm escalating this ticket to a higher level of support. We'll keep you updated.", '2023-12-25 05:30:00');
INSERT INTO Ticket_Comment (CommentID, TicketID, AuthorID, Comment, Date)
VALUES (8, 4, 7, "We're investigating the issue and will update you as soon as we have more information.", '2023-08-11 14:45:30');
INSERT INTO Ticket_Comment (CommentID, TicketID, AuthorID, Comment, Date)
VALUES (9, 5, 3, "Thanks for submitting this ticket. We'll look into the issue and get back to you soon.", '2023-06-05 19:20:15');
INSERT INTO Ticket_Comment (CommentID, TicketID, AuthorID, Comment, Date)
VALUES (10, 7, 4, "I'm taking ownership of this ticket and will work on resolving the issue.", '2023-10-18 07:10:05');
INSERT INTO Ticket_Comment (CommentID, TicketID, AuthorID, Comment, Date)
VALUES (11, 7, 5, "Thanks for letting me know about this issue. I'll work with my colleague to resolve it.", '2023-05-28 16:42:20');
INSERT INTO Ticket_Comment (CommentID, TicketID, AuthorID, Comment, Date)
VALUES (12, 8, 7, "We're investigating the issue and will update you as soon as we have more information.", '2023-09-01 12:15:45');
INSERT INTO Ticket_Comment (CommentID, TicketID, AuthorID, Comment, Date)
VALUES (13, 10, 6, 'I have reviewed the details of this ticket and have escalated it to the development team for further investigation.', '2023-07-10 21:59:30');
INSERT INTO Ticket_Comment (CommentID, TicketID, AuthorID, Comment, Date)
VALUES (14, 10, 6, 'The development team has completed their investigation and a fix for the issue has been implemented. Please let us know if you continue to experience any problems.', '2023-12-31 23:59:59');
INSERT INTO Ticket_Comment (CommentID, TicketID, AuthorID, Comment, Date)
VALUES (15, 11, 4, 'Thank you for submitting this ticket. Our support team will review it and provide an update as soon as possible.', '2023-08-27 09:30:00');
INSERT INTO Ticket_Comment (CommentID, TicketID, AuthorID, Comment, Date)
VALUES (16, 12, 3, 'I have reviewed the details of this ticket and have assigned it to our senior support specialist for further assistance.', '2023-06-11 17:05:10');
INSERT INTO Ticket_Comment (CommentID, TicketID, AuthorID, Comment, Date)
VALUES (17, 12, 3, 'Our senior support specialist has reviewed the issue and is working on a resolution. We will keep you updated on the progress.', '2023-10-03 06:45:15');
INSERT INTO Ticket_Comment (CommentID, TicketID, AuthorID, Comment, Date)
VALUES (18, 16, 7, 'Thank you for contacting us. Our support team will review your ticket and provide an update as soon as possible.', '2023-05-16 14:30:20');
INSERT INTO Ticket_Comment (CommentID, TicketID, AuthorID, Comment, Date)
VALUES (19, 16, 7, 'We have investigated the issue and determined that a fix is required. Our development team is working on a resolution and we will update you as soon as possible.', '2023-09-19 10:18:00');
INSERT INTO Ticket_Comment (CommentID, TicketID, AuthorID, Comment, Date)
VALUES (20, 17, 7, 'Thank you for submitting your ticket. Our support team will review it and provide an update as soon as possible.', '2023-07-28 20:50:30');
INSERT INTO Ticket_Comment (CommentID, TicketID, AuthorID, Comment, Date)
VALUES (21, 18, 7, 'Thank you for contacting us. Our support team will review your ticket and provide an update as soon as possible.', '2023-12-20 04:00:00');
...
INSERT INTO FAQ (Question, Answer) VALUES ('What do I do if I forget my username?', 'If you forget your username, please contact our support team for assistance.');
INSERT INTO FAQ (Question, Answer) VALUES ('How do I update my billing information?', 'You can update your billing information by going to your account settings and selecting "billing."');
INSERT INTO FAQ (Question, Answer) VALUES ('What are the system requirements for your software?', 'The system requirements for our software can be found on our website.');
INSERT INTO FAQ (Question, Answer) VALUES ('How do I cancel my subscription?', 'You can cancel your subscription by going to your account settings and selecting "subscriptions."');
INSERT INTO FAQ (Question, Answer) VALUES ('What should I do if I am having trouble accessing my account?', 'If you are having trouble accessing your account, please contact our support team for assistance.');
INSERT INTO FAQ (Question, Answer) VALUES ('How do I install your software?', 'Instructions for installing our software can be found on our website.');
INSERT INTO FAQ (Question, Answer) VALUES ('What do I do if I encounter an error message?', 'If you encounter an error message, please take a screenshot and send it to our support team for assistance.');
INSERT INTO FAQ (Question, Answer) VALUES ('How do I request a refund?', 'You can request a refund by contacting our support team.');
INSERT INTO FAQ (Question, Answer) VALUES ('What should I do if I have a question about your product?', 'If you have a question about our product, please contact our support team for assistance.');
INSERT INTO FAQ (Question, Answer) VALUES ('How do I upgrade my subscription?', 'You can upgrade your subscription by going to your account settings and selecting "subscriptions."');
INSERT INTO FAQ (Question, Answer) VALUES ('What do I do if I have a suggestion for your product?', 'If you have a suggestion for our product, please contact our support team.');
INSERT INTO FAQ (Question, Answer) VALUES ('How do I report a bug?', 'You can report a bug by contacting our support team and providing details about the issue.');
INSERT INTO FAQ (Question, Answer) VALUES ('What do I do if I am having trouble with a feature?', 'If you are having trouble with a feature, please contact our support team for assistance.');
INSERT INTO FAQ (Question, Answer) VALUES ('How do I change my account information?', 'You can change your account information by going to your account settings and selecting "account."');
INSERT INTO FAQ (Question, Answer) VALUES ('What are the accepted payment methods?', 'The accepted payment methods can be found on our website.');
...
INSERT INTO FAQ (Question, Answer) VALUES ('How do I change my password?', 'You can change your password by going to your account settings and selecting "security."');
INSERT INTO FAQ (Question, Answer) VALUES ('What do I do if I am not receiving emails from your company?', 'If you are not receiving emails from our company, please check your spam folder and contact our support team for assistance.');
INSERT INTO FAQ (Question, Answer) VALUES ('How do I download an invoice for my subscription?', 'You can download an invoice for your subscription by going to your account settings and selecting "invoices."');
INSERT INTO FAQ (Question, Answer) VALUES ('What do I do if I need technical support?', 'If you need technical support, please contact our support team for assistance.');
INSERT INTO FAQ (Question, Answer) VALUES ('How do I downgrade my subscription?', 'You can downgrade your subscription by going to your account settings and selecting "subscriptions."');
INSERT INTO FAQ (Question, Answer) VALUES ('What do I do if I need help with the checkout process?', 'If you need help with the checkout process, please contact our support team for assistance.');
INSERT INTO FAQ (Question, Answer) VALUES ('How do I check my account balance?', 'You can check your account balance by going to your account settings and selecting "balance."');
INSERT INTO FAQ (Question, Answer) VALUES ('What do I do if I am not satisfied with the product?', 'If you are not satisfied with the product, please contact our support team for assistance.');
INSERT INTO FAQ (Question, Answer) VALUES ('How do I delete my account?', 'You can delete your account by going to your account settings and selecting "delete account."');
INSERT INTO FAQ (Question, Answer) VALUES ('What do I do if I need to change my payment method?', 'If you need to change your payment method, please contact our support team for assistance.');
INSERT INTO FAQ (Question, Answer) VALUES ('How do I view my transaction history?', 'You can view your transaction history by going to your account settings and selecting "transactions."');
INSERT INTO FAQ (Question, Answer) VALUES ('What do I do if I need help setting up my account?', 'If you need help setting up your account, please contact our support team for assistance.');
INSERT INTO FAQ (Question, Answer) VALUES ('How do I enable two-factor authentication?', 'You can enable two-factor authentication by going to your account settings and selecting "security."');
INSERT INTO FAQ (Question, Answer) VALUES ('What do I do if I need to change the email associated with my account?', 'If you need to change the email associated with your account, please contact our support team for assistance.');
